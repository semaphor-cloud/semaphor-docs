...
<Tabs items={['Vue 3', 'Vue 2']} defaultIndex="1">
...
If you wish, you can also use the Web Component directly inside of your Vue project. To do that, first create a wrapper component like shown below and then import that regular component inside of your Vue project.
