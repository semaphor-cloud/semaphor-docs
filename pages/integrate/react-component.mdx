...
Next, you will need to get the `filterId` from Semaphor console. You can get the `filterId` from the filter's settings popover, and then hover on the ID icon to see the ID.
