...
Semaphore uses [Chart.js](https://www.chartjs.org/docs/latest/samples/bar/border-radius.html) for data visualization, offering complete flexibility to customize every aspect of your chart. You can override the **`options`** property of the chart and set global properties for your dashboard. Alternatively, you can customize individual cards when creating the dashboard. The properties set for individual cards are more specific and override the global properties.
