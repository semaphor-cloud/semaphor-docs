...
The above query throws an error in BigQuery. For all other dbs this is a valid syntax. As a workaround, you need to _alias_ the table when you access it the first time
