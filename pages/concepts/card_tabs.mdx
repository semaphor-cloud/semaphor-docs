...
In Semaphor, a dashboard is made up of frames. Each frame can contain multiple cards. You can display multiple visuals in a single frame by using card tabs. You can think of Semaphor frames as a deck of cards where each card is a visual.
